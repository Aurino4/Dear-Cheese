...
const almacendequesos=[  //1ero creamos el array un json que dentro va el id y el nombre
    {
        ...
        descripcion : "Se hace con leche entera,sin pasteurizar, de gran riqueza en mantequilla, procedente de la raza bovina auctóctona dela montaña.",
        foto : "img/quesorojocabra.jpg",
        precio: 9.10,
        categoria:"a",    
    },
    { id:2,
        nombre:"Queso oveja bredo",
        descripcion : "Se hace con leche entera,sin pasteurizar, de gran riqueza en mantequilla, procedente de la raza bovina auctóctona dela montaña.",
    ...
    {id:4,
        nombre:"Queso oveja la collada",
        descripcion : "Se hace con leche entera,sin pasteurizar, de gran riqueza en mantequilla, procedente de la raza bovina auctóctona dela montaña.",
        foto : "img/quesodeovjealacollada.jpg",
        precio: 9.10 ,
        categoria:"d",
    },
    {id:5,
        nombre:"Queso de coan",
        descripcion : "Se hace con leche entera,sin pasteurizar, de gran riqueza en mantequilla, procedente de la raza bovina auctóctona dela montaña.",
        foto : "img/quesodecoan.jpg",
        precio: 9.10 ,
        categoria:"e",
    },
    {id:6,
        nombre:"Queso de cabrales",
        descripcion : "Se hace con leche entera,sin pasteurizar, de gran riqueza en mantequilla, procedente de la raza bovina auctóctona dela montaña.",
    ...
    {id:8,
        nombre:"Queso fuega al pitu",
        descripcion : "Se hace con leche entera,sin pasteurizar, de gran riqueza en mantequilla, procedente de la raza bovina auctóctona dela montaña.",
        foto : "img/quesofuegaalpitu.jpg",
        precio: 9.10 ,
        categoria:"h",
    },
];
